...
execute if entity @a[tag=ndlhAOzxg4bFlFRslbmKPLyiIeZ1mz5ynCTiFpyq] run function tlkot:mp8zmr4a6ljxuyar8kw__gx0_7mcueai25ft_ljw
...
execute if entity @s[scores={99U+r2nhFTwAKng1=500000..}] run advancement grant @a only tlkot:achievements/true_assassin