...
scoreboard players set @a CCfT7iia4CiZa5lp 1
execute if entity @a[tag=QMTVMm3OdA_n.+KhMql9RoDoV453kXo4SdpmKIM4] run function tlkot:a555fekqrg14q5li4hsrzfdzcdmr6m8ynop-4pfq