...
scoreboard players add @a[scores={yYMZQeeb5cdluIIb=720}] Yil+Eia5XVG2pWbJ 1
scoreboard players remove @a[scores={yYMZQeeb5cdluIIb=0..}] yYMZQeeb5cdluIIb 1
tag @a[scores={3UrLDFu8Mdv89c13=0}] add qKHmjTsO0960gVj8-aPBO7-9vH65+Qv+lhkd+Ndg
execute if entity @a[scores={3UrLDFu8Mdv89c13=480}] run function tlkot:v12alp6vq-r_l7muob78h4ujfv0jew9xldyvcn_e
scoreboard players add @a[scores={3UrLDFu8Mdv89c13=160}] ZuGl0RaLBryC5YUo 1
scoreboard players add @a[scores={3UrLDFu8Mdv89c13=320}] ZuGl0RaLBryC5YUo 1
scoreboard players add @a[scores={3UrLDFu8Mdv89c13=520}] ZuGl0RaLBryC5YUo 1
scoreboard players add @a[scores={3UrLDFu8Mdv89c13=720}] ZuGl0RaLBryC5YUo 1
