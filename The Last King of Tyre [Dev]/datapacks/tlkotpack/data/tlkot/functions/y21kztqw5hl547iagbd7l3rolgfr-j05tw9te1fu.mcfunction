...
execute if entity @s[tag=n+84rF_TNjBFZ2lYrhDC5EsEopI_V7qDO2obUjdy] run fill ~-1 ~ ~-1 ~1 ~ ~1 minecraft:air replace minecraft:jack_o_lantern
...
execute if entity @s[tag=n+84rF_TNjBFZ2lYrhDC5EsEopI_V7qDO2obUjdy] as @a[nbt={OnGround:1b}] at @s run function tlkot:31_x8k3xffcc-mlp72scrp98a5oll4dfxsthfn_p
