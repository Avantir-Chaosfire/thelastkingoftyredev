...
advancement grant @a[scores={CutsceneTime=<#EndCrystalDuration#>}] only tlkot:achievements/condemnation

tp @a[scores={CutsceneTime=<#!EndCrystalDuration 1 +#>..}] <#CreditsLocation#>
scoreboard players set @a[scores={CutsceneTime=<#!EndCrystalDuration 1 +#>}] EndingTalk <#EndingDialoguePurgeHumansID#>