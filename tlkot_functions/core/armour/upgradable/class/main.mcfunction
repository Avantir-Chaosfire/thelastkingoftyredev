...
item replace entity @a[tag=AlreadyEquipped<1>1Chest,tag=Wearing<1>Head,tag=Wearing<1>Inactive1Chest,tag=Wearing<1>Legs,tag=Wearing<1>Feet] armor.chest with <#<1>Active1Chest#>
item replace entity @a[tag=AlreadyEquipped<1>2Chest,tag=Wearing<1>Head,tag=Wearing<1>Inactive2Chest,tag=Wearing<1>Legs,tag=Wearing<1>Feet] armor.chest with <#<1>Active2Chest#>
...
execute if entity @a[tag=Wearing<1>Active1Chest] unless entity @a[tag=Wearing<1>Head,tag=Wearing<1>Legs,tag=Wearing<1>Feet] run item replace entity @a armor.chest with <#<1>Inactive1Chest#>
execute if entity @a[tag=Wearing<1>Active2Chest] unless entity @a[tag=Wearing<1>Head,tag=Wearing<1>Legs,tag=Wearing<1>Feet] run item replace entity @a armor.chest with <#<1>Inactive2Chest#>
