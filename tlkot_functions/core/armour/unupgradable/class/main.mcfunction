...
item replace entity @a[tag=AlreadyEquipped<1>Chest,tag=Wearing<1>Head,tag=Wearing<1>Chest,tag=Wearing<1>Legs,tag=Wearing<1>Feet] armor.chest with <#<1>ActiveChest#>
...
execute if entity @a[tag=Wearing<1>ActiveChest] unless entity @a[tag=Wearing<1>Head,tag=Wearing<1>Legs,tag=Wearing<1>Feet] run item replace entity @a armor.chest with <#<1>Chest#>
