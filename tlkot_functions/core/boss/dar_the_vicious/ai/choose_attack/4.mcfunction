...
#Charge: 10..30, last two attacks weren't Charge
execute if entity @a[distance=10..30] unless entity @s[scores={LastDarAttack=<#DarAttackCharge#>}] unless entity @s[scores={Last2DarAttack=<#DarAttackCharge#>}] run scoreboard players set @s DarAttack <#DarAttackCharge#>
...
#Line Smash 6..14, last two attacks weren't Line Smash
execute if entity @a[distance=6..16] unless entity @s[scores={LastDarAttack=<#DarAttackLineSmash#>}] unless entity @s[scores={Last2DarAttack=<#DarAttackLineSmash#>}] run scoreboard players set @s DarAttack <#DarAttackLineSmash#>
