...
execute if entity @s[tag=Skin] run function tlkot:core/boss/disgraceful_beast/ai/hurt/skin
execute if entity @s[tag=Core] run function tlkot:core/boss/disgraceful_beast/ai/hurt/core
